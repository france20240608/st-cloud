...
import com.st.cloud.module.user.pojo.dto.MemberUserDTO;
...
public class MemberUserController {
    ...
    public CommonResult<MemberUserDO> getUserByUserId(@RequestBody MemberUserDTO dto) {
        MemberUserDO user = userService.getUserByUserId(dto.getId());
