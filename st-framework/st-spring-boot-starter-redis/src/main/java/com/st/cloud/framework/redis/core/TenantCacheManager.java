package com.st.cloud.framework.redis.core;
...
public class TenantCacheManager extends SimpleCacheManager {
    ...
    private Cache buildRemote(QuickConfig config) {
        ...
        if(!TenantContextHolder.isIgnore()) {
            prefix += ":" + TenantContextHolder.getTenantId() + ":";
        }
        ...
        if (cacheBuilder.getConfig().getKeyPrefixSupplier() != null) {
            ...
            cacheBuilder.setKeyPrefixSupplier(() -> supplier.get() + finalPrefix);
        } else {
...
//        if (cacheBuilder.getConfig().get != null) {
//            Supplier<String> supplier = cacheBuilder.getConfig().getKeyPrefixSupplier();
//            String finalPrefix = prefix;
//            cacheBuilder.setKeyPrefixSupplier(() -> supplier.get() + finalPrefix);
//        } else {
